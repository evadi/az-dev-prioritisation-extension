...
export default class Risk extends MatrixBase {
    constructor() {
        ...
        this.scoreLookup["Accept risk"] = 9;
        this.scoreLookup["Create mitigating strategies, monitor risk regularly"] = 6;
        this.scoreLookup["Protect position, invest to fix ASAP, gets top priority"] = 2;
        this.scoreLookup["Protect Position, invest to fix immediately everything else goes on hold"] = 1;
    }
}